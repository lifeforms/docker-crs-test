...
# Some symlinks for FTW
mkdir -p /var/log/apache2
ln -s /var/log/nginx/error.log /var/log/apache2/error.log
ln -s /var/log/nginx/access.log /var/log/apache2/access.log
ln -s /var/log/nginx/modsec_audit.log /var/log/modsec_audit.log
